...
import it.giotech.saes.gateway.JhgateApp;
import it.giotech.saes.gateway.config.TestSecurityConfiguration;
import io.github.jhipster.config.JHipsterProperties;
import it.giotech.saes.gateway.config.audit.AuditEventConverter;
import it.giotech.saes.gateway.domain.PersistentAuditEvent;
import it.giotech.saes.gateway.repository.PersistenceAuditEventRepository;
import it.giotech.saes.gateway.security.AuthoritiesConstants;

import it.giotech.saes.gateway.service.AuditEventService;
...
@SpringBootTest(classes = {JhgateApp.class, TestSecurityConfiguration.class})
@Transactional
