...
@RestController
@RequestMapping("/api/jhgate-kafka")
public class JhgateKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhgateKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhgateKafkaResource(KafkaProperties kafkaProperties) {
