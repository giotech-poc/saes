...
# PRE-Start Architecture Microservices [FIRST TIME]

> docker-compose -f src/main/docker/kafka.yml up -d
> docker-compose -f src/main/docker/jhipster-registry.yml up -d
> docker-compose -f src/main/docker/keycloak.yml up -d

# http://localhost:9080/auth/admin (keycloak console)

# [OTHER]

> docker start docker_keycloak_1 docker_kafka_1 docker_zookeeper_1 docker_jhipster-registry_1

# JHGATE - JHipster Gateway

> cd jhgate && mvnw (localhost:8080 --> JHGate 0.0.\*.snapshot)
> cd jhgate && npm start (localhost:9000 --> JHGate xDev, localhost:3001 --> BrowserSync)
...
To build the final jar and optimize the jhgate application for production, run:
